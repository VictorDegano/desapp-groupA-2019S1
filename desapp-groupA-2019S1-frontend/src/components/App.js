...
class App extends React.Component {
    ...
    componentWillMount(){
        ...
        eventApi.getMisUltimosEventos(1)
            .then((response) => {
                this.setState({
    ...
    render(){
        return <div>
                <NavigationBar/>
                <EventsComponent title={"Mis eventos en curso:"} arrayDeEventos={this.state.eventosEnCurso}/>
                <EventsComponent title={"Mis ultimos eventos:"} arrayDeEventos={this.state.misUltimosEventos}/>
